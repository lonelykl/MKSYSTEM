...
<li class="active"><?php echo '<a href="report.php'.$sessionInfoCond.'">';?>Report</a></li>
...
?>
<td>
<form action="report_contribution.php<?php echo $sessionInfoCond ?>" method="post" target="iframe1">
<input type="submit" value="Contribution" class="btn btn-primary" >
</form>
</td>
<?php } ?>
<td>
<form action="report_transaction.php<?php echo $sessionInfoCond ?>" method="post" target="iframe1">
